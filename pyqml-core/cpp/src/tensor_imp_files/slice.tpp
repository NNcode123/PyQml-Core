...
/*
template <typename T>
inline void tensor<T>::getIndex(AxisIter *axis_info, size_t start_dim, size_t end_dim, const T *__restrict &src) const
{
...
template <typename T>
inline int64_t tensor<T>::getIndex(std::vector<AxisIter> &axis_info,
...
template <typename T>
inline void tensor<T>::getIndex(size_t *cur_counts, const int64_t *new_strides,
                                size_t start_index, size_t end_index, int64_t &cur_pos) const
{
...
template <typename T>
template <typename V>
inline void tensor<T>::getIndex(AxisIter *axes_a, AxisIter *axes_b, size_t start_index, size_t end_index, const T *__restrict &a_data, const V *__restrict &b_data) const
{
